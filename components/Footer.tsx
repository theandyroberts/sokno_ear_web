    ...
    <footer style={{ background: "var(--ink-black)", color: "var(--paper-cream)", borderTop: "var(--border-heavy) solid var(--ink-black)" }}>
      <Page style={{ padding: "30px 24px 28px" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 20, flexWrap: "wrap" }}>
          <img src="/assets/spots/foot_dog.png" alt="" style={{ height: 84, width: "auto", filter: "invert(1) brightness(1.05) sepia(0.15)" }} />
          ...
          <img src="/assets/spots/foot_bridge.png" alt="" style={{ height: 70, width: "auto", filter: "invert(1) brightness(1.05) sepia(0.15)" }} />
        </div>
